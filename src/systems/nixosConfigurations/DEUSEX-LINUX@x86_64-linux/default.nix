...
in {
  ...
  boot = {
    ...
    kernelPatches = [
      {
        name = "0001-ENGG-V2-drm-amd-display-Fix-gpu-reset-for-multidispl.patch";
        patch = ./kernelPatches/0001-ENGG-V2-drm-amd-display-Fix-gpu-reset-for-multidispl.patch;
      }
      {
        name = "drm-amd-fpu-01.patch";
        patch = ./kernelPatches/drm-amd-fpu-01.patch;
      }
      {
        name = "drm-amd-fpu-02.patch";
        patch = ./kernelPatches/drm-amd-fpu-02.patch;
      }
      {
        name = "drm-amd-fpu-03.patch";
        patch = ./kernelPatches/drm-amd-fpu-03.patch;
      }
    ];
