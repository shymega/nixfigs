...
in {
  ...
  options.wayland.windowManager.hyprland = {
    ...
    finalPackage = lib.mkOption {
      ...
      default =
        if cfg.package != null
        then cfg.package.override {enableXWayland = cfg.xwayland.enable;}
        else null;
      defaultText =
        lib.literalMD
    ...
    finalPortalPackage = lib.mkOption {
      ...
      readOnly = true;
      default =
        if (cfg.portalPackage != null)
        then
          if cfg.finalPackage != null
          then cfg.portalPackage.override {hyprland = cfg.finalPackage;}
          else cfg.portalPackage
        else null;
  ...
  config = lib.mkIf cfg.enable {
    ...
    xdg.portal = {
      ...
      configPackages =
        lib.mkIf (cfg.finalPackage != null)
