...
let
  ...
  workSecrets =
    # From passwords.yaml
    (mkSecret "workuser-password" ../../../secrets/work/hosts/${hostname}/passwords.yaml {
      neededForUsers = true;
    })
    ...
    // (mkSecret "corporate-wifi-cert" ../../../secrets/work/hosts/${hostname}/wifi-credentials.yaml {
      mode = "0444";
    })
    //
    ...
    // (mkSecret "corporate-intermediate-ca" ../../../secrets/work/shared/corporate-ca.yaml {
      mode = "0444";
    })
  ...
  personalSecrets =
    # From passwords.yaml
    mkSecret "dzrodriguez_password" ../../../secrets/personal/hosts/${hostname}/passwords.yaml {
        neededForUsers = true;
      };
...
in
{
  ...
  sops = {
    ...
    defaultSopsFile =
      if isWork then
        ../../../secrets/work/hosts/${hostname}/passwords.yaml
      else if isPersonal then
        ../../../secrets/personal/hosts/${hostname}/passwords.yaml
      else
        ../../../secrets/hosts/${hostname}/passwords.yaml; # Fallback for other roles
