...
hosts-personal:
    ...
    @nix eval --json {{override_args}} '.#nixosConfigurations' --apply 'lib.filterAttrs (n: v: builtins.elem "personal" v.config.nixfigs.meta.rolesEnabled) >> builtins.attrNames' 2>/dev/null | jq -r '.[]' || echo "HEIMDALL-LINUX"
