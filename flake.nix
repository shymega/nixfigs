...

{
  ...
  outputs =
    ...
    in
    {
      ...
      generators = inputs.nixfigs-private.generators // inputs.nixfigs-public.generators;
      common = inputs.nixfigs-common.common // inputs.nixpkgs-private.common;
      inherit (inputs.nixfigs-helpers) helpers;
      homeConfigurations = inputs.nixpkgs-homes.homeConfigurations // inputs.nixpkgs-private.homeConfigurations;
      homeModules = inputs.nixpkgs-homes.homeModules // inputs.nixpkgs-private.homeModules;
      ...
      #      inherit (inputs.nixfigs-devenvs) templates legacyShells;
    };
  inputs = {
